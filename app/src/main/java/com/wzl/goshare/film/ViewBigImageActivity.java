...
import com.wzl.goshare.utils.CheckNetwork;
import com.wzl.goshare.utils.PermissionHandler;
        ...
        tvSaveBigImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ToastUtil.showToast("图片已存在");
                    ...
                    // 网络图片
                    RxSaveImage.saveImageToGallery(ViewBigImageActivity.this, imageList.get(page), imageTitles.get(page));
                }
            }
        });
    }
